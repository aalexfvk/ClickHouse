...
ConnectionPoolWithFailover::ConnectionPoolWithFailover(
        ...
        size_t circuit_breaker_ban_min_ms_,
        size_t circuit_breaker_ban_max_ms_,
    ...
    : Base(
        ...
        max_error_cap_,
        getLogger("ConnectionPoolWithFailover"),
        circuit_breaker_ban_min_ms_,
        circuit_breaker_ban_max_ms_)
