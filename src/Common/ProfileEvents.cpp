...
#define APPLY_FOR_BUILTIN_EVENTS(M) \
    ...
    M(DistributedConnectionCircuitBreakerBan, "Number of times a replica was banned by the circuit breaker after consecutive connection failures.", ValueType::Number) \
